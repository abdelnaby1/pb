...
const VerticalProductsForm = ({onClose}:IProps) => {
  ...
  const onProductsSubmit: SubmitHandler<IProducts> = async (data) => {
           try {
            ...
            await setDoc(widgetsRef,{data: arrayUnion({...data,component_type:"Vertical_Products"})},{merge:true})
  ...
  return (
      <div className="mt-5">
        <h2 className="text-center mb-4 text-3xl font-semibold">Add Vertical Products Widget</h2>
